...
module.exports = {
  ...
  chmod: function(ssh, path, mode) {
    if (!ssh) {
      ...
      return new Promise(function(resolve, reject) {
        var open, ref, ref1, ref2, ref3;
        // ssh@0.3.x use "_state"
        // ssh@0.4.x use "_sshstream" and "_sock"
        // ssh@1.7.0 use "ssh._writableState?.ended"
        open = ((ssh._state != null) && ssh._state !== 'closed') || (((ref = ssh._sshstream) != null ? ref.writable : void 0) && ((ref1 = ssh._sock) != null ? ref1.writable : void 0)) || (((ref2 = ssh._sock) != null ? (ref3 = ref2._writableState) != null ? ref3.ended : void 0 : void 0) === false);
        if (!open) {
  ...
  writeFile: function(ssh, target, data, options = {}) {
    ...
    if (!ssh) {
      ...
      return new Promise(function(resolve, reject) {
        var error, open, ref, ref1, ref2, ref3;
        error = false;
        // ssh@0.3.x use "_state"
        // ssh@0.4.x use "_sshstream" and "_sock"
        // ssh@1.7.0 use "ssh._writableState?.ended"
